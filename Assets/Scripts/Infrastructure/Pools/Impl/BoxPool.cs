...
namespace Infrastructure.Pools.Impl
{
    public class BoxPool : IInitializable, IDisposable
    {
        ...
        private Dictionary<EBoxGrade, EntityPool<BoxView>> _pools;
        ...
        {
            _pools = new Dictionary<EBoxGrade, EntityPool<BoxView>>();
        ...
        private EntityPool<BoxView> CreatePoolForGrade(EBoxGrade grade, Transform parentTransform)
        {
        ...
        private void PreloadPool(EntityPool<BoxView> pool, int count)
        {
